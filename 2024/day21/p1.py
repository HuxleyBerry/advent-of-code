...
for code in codes:
   ...
   sequences2 = chain(*(get_button_sequences(sequence, direction_keypad_to_positions) for sequence in sequences1))
   sequences3 = chain(*(get_button_sequences(sequence, direction_keypad_to_positions) for sequence in sequences2))
